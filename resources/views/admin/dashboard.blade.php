        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-slate-800 overflow-hidden shadow-xl sm:rounded-lg border border-slate-700">
                <div class="p-6 border-b border-slate-700">
                    ...
                    <p class="mb-4 text-gray-400">Desde aquí puedes gestionar el inventario, autorizar usuarios y
                        examinar las cotizaciones recibidas desde el sitio público.</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8 mb-10">
                        <div class="bg-slate-900 p-6 rounded-lg text-center border border-slate-700 shadow-inner">
                            ...
                            <span class="text-xs font-bold text-gray-500 uppercase tracking-widest">Equipos
                                Activos</span>
                        </div>
                        <div class="bg-slate-900 p-6 rounded-lg text-center border border-slate-700 shadow-inner">
                    ...
                    <h4 class="text-lg text-white font-bold mb-4 border-b border-slate-700 pb-2">Cotizaciones Recientes
                    </h4>
                    <div class="overflow-x-auto rounded-lg border border-slate-700">
                        <table class="min-w-full divide-y divide-slate-700">
                            <thead class="bg-slate-900">
                                <tr>
                                    <th scope="col"
                                        class="px-6 py-3 text-left text-xs font-bold text-orange-500 uppercase tracking-wider">
                                        Cliente</th>
                                    <th scope="col"
                                        class="px-6 py-3 text-left text-xs font-bold text-orange-500 uppercase tracking-wider">
                                        Contacto</th>
                            ...
                            <tbody class="bg-slate-800 divide-y divide-slate-700">
                                ...
                                <tr class="hover:bg-slate-700 transition duration-150">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div class="text-sm text-gray-400 font-semibold">{{ $quote->company ?:
                                            'Particular' }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-300"><a href="mailto:{{ $quote->email }}"
                                ...
                                <tr>
                                    <td colspan="5"
                                        class="px-6 py-8 text-center text-sm font-semibold text-slate-500 bg-slate-900/50">
